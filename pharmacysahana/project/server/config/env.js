...
// Production safety: warn if using the default JWT secret
if (env.NODE_ENV === 'production' && !process.env.JWT_SECRET) {
  console.warn('⚠️  WARNING: Using default JWT_SECRET in production. Set JWT_SECRET environment variable for security.');
}
