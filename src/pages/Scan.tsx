...
{step === 'done' && result && (
        ...
        {step === 'done' && qrKind === 'box' && boxData && (
          <div className="space-y-4">
            ...
            {boxData.isDemo && (
              <p className="text-xs text-amber-500 bg-amber-500/10 border border-amber-500/30 rounded-xl p-3">
                ⚠ Demo tracking data — locations are simulated for demonstration.
              </p>
            )}
          </div>
        )}
